...
<!-- declare elements --> 
  <div class="container">
    <div class="row">
       ...
       <fieldset>
    	   <input type="hidden" name="_token" value="s88GrSz8cgOmQc8A1bcSg6NYQe5GdXBSDUXRAnEd">
           <input type="hidden" name="querystring" id="querystring" class="form-control" value="" />
           <input type="hidden" name="ip" id="ip" class="form-control" value="10.103.17.52" />
           ...
           <label for="staffid" class="col-sm-3 control-label required">Staff ID</label>
            ...
            <div class="col-sm-9" placement="top" data-toggle="tooltip" data-placement="auto"
                                 title="FORs classify R&D activities according to their scientific and academic disciplines (see MRDCS 6th Ed. 2011 MOSTI/MASTIC). You may choose more than ONE FOR"   value="">
...
<!-- code that make the page load faster --> 
